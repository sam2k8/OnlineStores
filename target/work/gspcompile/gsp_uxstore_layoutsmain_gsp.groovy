...
class gsp_uxstore_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(5)
invokeTag('createLinkTo','g',22,['dir':("css"),'file':("custom.css")],-1)
printHtmlPart(6)
invokeTag('stylesheet','asset',23,['src':("application.css")],-1)
printHtmlPart(1)
invokeTag('javascript','asset',24,['src':("application.js")],-1)
printHtmlPart(1)
...
createTagBody(1, {->
printHtmlPart(8)
invokeTag('image','asset',28,['src':("grails_logo.png"),'alt':("Grails")],-1)
printHtmlPart(9)
...
public static final long LAST_MODIFIED = 1454497596444L
